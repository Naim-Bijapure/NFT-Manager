...
function AdminDebug({ yourLocalBalance, readContracts, writeContracts, localProvider, userSigner }) {
  ...
  const mintNFT = async () => {
    ...
    const tx = await yourNFT.mint("http://asdfasdfasdf.com", 500);
  ...
  const createMarketItem = async () => {
    ...
    const tx = await NFTmanager.createMarketItem(yourNFT.address, 0, ethers.utils.parseEther("1"), {
